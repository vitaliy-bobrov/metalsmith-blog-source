...
- Houdini
---
"CSS Properties and Values API Level 1" is a brand new draft for CSS specification module. It gives developers the power to extend stylesheet dictionary. I have already mentioned custom properties in my previous articles: ["Exploring the CSS Paint API"](https://bobrov.dev/blog/css-paint-in-action-bar-chart/) and ["CSS Paint in Action: Bar Chart"](https://bobrov.dev/blog/css-paint-in-action-bar-chart/). But today I want to introduce them in as many details as possible. So let's start our journey into properties and values far depths ⚓!

The topic splitted into two parts. Now you are reading the first one. You can check out the second part [here](https://bobrov.dev/blog/css-custom-properties-in-depth-part-2/).{post__series}
